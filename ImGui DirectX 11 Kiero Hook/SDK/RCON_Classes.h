...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_KF60[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8HEF[0x6];                                   // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_273N[0x10];                                  // 0x0060(0x0010) MISSED OFFSET (PADDING)
