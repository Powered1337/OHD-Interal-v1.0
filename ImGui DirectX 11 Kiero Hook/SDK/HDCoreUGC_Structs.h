...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_679R[0x90];                                  // 0x0000(0x0090) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UKGI[0x50];                                  // 0x0098(0x0050) MISSED OFFSET (PADDING)
	};
