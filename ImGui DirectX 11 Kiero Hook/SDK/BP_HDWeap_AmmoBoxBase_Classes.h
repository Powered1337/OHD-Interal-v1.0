...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_HDWeap_AmmoBoxBase.BP_HDWeap_AmmoBoxBase_C
	...
	public:
		...
		bool                                                       bDoNotRefillPartialClips;                                // 0x0A99(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_S9XW[0x2];                                   // 0x0A9A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    AmmoClipAmount;                                          // 0x0A9C(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    TotalRestoreAmount;                                      // 0x0AA0(0x0004) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    AmmoRestoreRemaining;                                    // 0x0AA4(0x0004) Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash
	...
	public:
		...
		void ReplenishAmmo(class ADFBaseCharacter* Pawn, int32_t Ammo, int32_t* ClipsRestored);
		void AmmoAuraEffect();
		...
		void ExecuteUbergraph_BP_HDWeap_AmmoBoxBase(int32_t EntryPoint);
