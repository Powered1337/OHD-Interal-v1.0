...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_OMWeap_M1903_Scoped_P.BP_OMWeap_M1903_Scoped_P_C
	 * Size -> 0x000C (FullSize[0x0A60] - InheritedSize[0x0A54])
	 */
	class ABP_OMWeap_M1903_Scoped_P_C : public ABP_HDWeaponBase_C
	{
	public:
		unsigned char                                              UnknownData_RO4F[0x4];                                   // 0x0A54(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
