...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_OM_GERBag_Weap_1P.ABP_OM_GERBag_Weap_1P_C
	 * Size -> 0x0180 (FullSize[0x03E8] - InheritedSize[0x0268])
	 */
	class UABP_OM_GERBag_Weap_1P_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_7EFG[0x8];                                   // 0x0268(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_ABP_OM_GERBag_Weap_1P(int32_t EntryPoint);
