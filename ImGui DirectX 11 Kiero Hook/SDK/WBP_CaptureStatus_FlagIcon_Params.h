...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CEXL[0x6];                                   // 0x008A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_ZR0N[0x7];                                   // 0x0089(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		struct FSlateBrush                                         NewBrush;                                                // 0x0090(0x0088)  (Parm, OutParm)
	};
