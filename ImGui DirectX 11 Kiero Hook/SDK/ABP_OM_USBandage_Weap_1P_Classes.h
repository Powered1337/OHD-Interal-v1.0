...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_OM_USBandage_Weap_1P.ABP_OM_USBandage_Weap_1P_C
	 * Size -> 0x03C2 (FullSize[0x062A] - InheritedSize[0x0268])
	 */
	class UABP_OM_USBandage_Weap_1P_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_VD69[0x8];                                   // 0x0268(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_ABP_OM_USBandage_Weap_1P(int32_t EntryPoint);
