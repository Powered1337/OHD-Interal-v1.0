...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_8QDL[0x8];                                   // 0x0220(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5VMS[0x4];                                   // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SS3D[0x4];                                   // 0x026C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GR2X[0x8];                                   // 0x0888(0x0008) MISSED OFFSET (PADDING)
