...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_OMProj_Stielhandgranate_P.BP_OMProj_Stielhandgranate_P_C
	 * Size -> 0x0010 (FullSize[0x03D8] - InheritedSize[0x03C8])
	 */
	class ABP_OMProj_Stielhandgranate_P_C : public ABP_HDProj_GrenadeBase_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_BP_OMProj_Stielhandgranate_P(int32_t EntryPoint);
