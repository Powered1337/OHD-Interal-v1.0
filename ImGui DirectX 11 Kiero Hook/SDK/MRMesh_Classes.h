...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1VD0[0x4];                                   // 0x0204(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KH6C[0x4];                                   // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_O5KE[0x18];                                  // 0x0248(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_S0EE[0x8];                                   // 0x0408(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_8NPQ[0x5];                                   // 0x041B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EXNS[0x40];                                  // 0x0440(0x0040) MISSED OFFSET (PADDING)
