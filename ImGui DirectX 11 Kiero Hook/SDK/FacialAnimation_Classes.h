...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_3NW8[0x8];                                   // 0x07D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R66P[0x2C];                                  // 0x07E4(0x002C) MISSED OFFSET (PADDING)
