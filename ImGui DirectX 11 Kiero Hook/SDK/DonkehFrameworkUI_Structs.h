...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_U3LL[0x5];                                   // 0x000B(0x0005) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_D760[0x7];                                   // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SR1A[0x7];                                   // 0x0129(0x0007) MISSED OFFSET (PADDING)
	};
