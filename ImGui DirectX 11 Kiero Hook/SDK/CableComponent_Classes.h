...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TQ2S[0x6];                                   // 0x0432(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_33X4[0x2];                                   // 0x0486(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TIB7[0x18];                                  // 0x04A8(0x0018) MISSED OFFSET (PADDING)
