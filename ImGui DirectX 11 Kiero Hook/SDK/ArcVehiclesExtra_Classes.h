...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LZ81[0x3];                                   // 0x0231(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A7GV[0x1C];                                  // 0x023C(0x001C) MISSED OFFSET (PADDING)
