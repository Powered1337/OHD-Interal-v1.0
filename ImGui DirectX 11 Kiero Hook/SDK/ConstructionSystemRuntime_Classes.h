...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_OP83[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SNE3[0x120];                                 // 0x0048(0x0120) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LV2H[0x7];                                   // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<EConstructionSystemToolType, class UConstructionSystemTool*> Tools;                                                   // 0x00F8(0x0050) Transient, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_2WAK[0x8];                                   // 0x0148(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VEJI[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KJNN[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VFVC[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5X16[0x54];                                  // 0x003C(0x0054) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1X0A[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_GP2B[0x3];                                   // 0x043D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5DSU[0xC];                                   // 0x0444(0x000C) MISSED OFFSET (PADDING)
