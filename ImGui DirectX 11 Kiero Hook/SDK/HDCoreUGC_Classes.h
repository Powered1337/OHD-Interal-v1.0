...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_W6XJ[0x20];                                  // 0x0028(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FHDCoreUGCPluginStateMachineProperties              StateProperties;                                         // 0x0048(0x00E8) Transient, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_LOTZ[0xD8];                                  // 0x0130(0x00D8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_M08M[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JZ6E[0x50];                                  // 0x00B0(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JU0O[0x8];                                   // 0x0108(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_U70Q[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
