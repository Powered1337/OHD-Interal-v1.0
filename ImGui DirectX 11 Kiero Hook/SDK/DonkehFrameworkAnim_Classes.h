...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NDT5[0x7];                                   // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_C59P[0x3];                                   // 0x00E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5W93[0x1C];                                  // 0x0104(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BPIH[0x2];                                   // 0x012E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F8ZR[0xB];                                   // 0x0145(0x000B) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_6ZSG[0x8];                                   // 0x0268(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_MBZO[0x2];                                   // 0x0292(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_QT0P[0x8];                                   // 0x0268(0x0008) Fix Super Size
