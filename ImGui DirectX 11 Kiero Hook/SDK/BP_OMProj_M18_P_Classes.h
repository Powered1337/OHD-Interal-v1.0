...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass BP_OMProj_M18_P.BP_OMProj_M18_P_C
	 * Size -> 0x0014 (FullSize[0x0438] - InheritedSize[0x0424])
	 */
	class ABP_OMProj_M18_P_C : public ABP_HDProj_SmokeGrenadeBase_C
	{
	public:
		unsigned char                                              UnknownData_614I[0x4];                                   // 0x0424(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BP_OMProj_M18_P(int32_t EntryPoint);
