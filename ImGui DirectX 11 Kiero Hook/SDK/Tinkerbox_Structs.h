...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UHHN[0x1];                                   // 0x001D(0x0001) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		unsigned char                                              UnknownData_MO2G[0x2];                                   // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3EKD[0x4];                                   // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
