...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_BNRI[0x60];                                  // 0x0220(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EZXR[0x3];                                   // 0x0365(0x0003) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0DN9[0x60];                                  // 0x00B0(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HGX2[0x3];                                   // 0x01F5(0x0003) MISSED OFFSET (PADDING)
