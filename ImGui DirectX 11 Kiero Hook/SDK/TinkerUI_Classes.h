...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_JH4J[0x10];                                  // 0x0438(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		bool                                                       UnknownData_ARX1 : 2;                                    // 0x0448(0x0001) BIT_FIELD (PADDING)
		...
		unsigned char                                              UnknownData_J5PH[0x17];                                  // 0x0449(0x0017) MISSED OFFSET (PADDING)
